...
| `dm3q-S918BXXSAFZF5` | Galaxy S23 Ultra `SM-S918B` | `5.15.189` | QEMU-tested; hardware validation requested |
...
make TARGET=dm3q-S918BXXSAFZF5 STACK_WRITER=mcast ANDROID_NDK_HOME=/path/to/android-ndk
make TARGET=dm3q-S918BXXSAFZF5 STACK_WRITER=sigreturn ANDROID_NDK_HOME=/path/to/android-ndk
```
...
[`docs/SM-A366W-A366WVLS3AYG1.md`](docs/SM-A366W-A366WVLS3AYG1.md). The
experimental SM-S918B FZF5 port, its two stack-writer backends, exact local-app
test steps, and QEMU validation record are in
[`docs/SM-S918B-S918BXXSAFZF5.md`](docs/SM-S918B-S918BXXSAFZF5.md).
